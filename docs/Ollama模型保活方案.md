...
在**Ollama服务器**(192.168.8.231)上配置环境变量,让模型永不卸载:
...
**解决方案**:
1. 检查Ollama服务状态: `curl http://192.168.8.231:11434/api/tags`
2. 检查网络连通性: `ping 192.168.8.231`
3. 确认配置: `OLLAMA_BASE_URL=http://192.168.8.231:11434`
