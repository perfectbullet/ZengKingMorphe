...
导致原本应走数学模型的数学题被通用 LLM 接住、原本应走 RAG 的教材题被通用 LLM 直答。
...
_MATH_KEYWORD = re.compile(
    ...
    r"直线|曲线|射线|线段|切线|渐近线|"                          # 线
    r"交点|切点|顶点|端点|零点|极值点|对称点|拐点|"               # 特殊点
    r"斜率|截距|坐标|象限|倾角|"                                 # 解析几何
    ...
    r"为多少|等于多少|"                                         # 问法模式
    r"除以|乘以|平方|立方|次方|开方|根号|"                       # ASR 口语化运算
    r"不等于|大于等于|小于等于|大于零|小于零|等于零|"             # ASR 口语化比较
    r"比较.{0,50}的大小)"                                       # ASR 比较大小
)
